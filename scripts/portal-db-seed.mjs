...
const assets = [
  ...
  [12, SITE_AEKTANAGAR, SURVEY_AEKTANAGAR, "drawing", "Contour Map, 1 m interval", "contour-map.pdf",
    "demo-client/aektanagar/drawings/contour-map.pdf", "application/pdf",
    "108 contour lines from 30 to 97 m, index every 5 m, drawn to scale in UTM 43N.", 1],
  ...
  [18, SITE_AEKTANAGAR, SURVEY_AEKTANAGAR, "lidar", "LiDAR Point Cloud, survey summary", "point-cloud-summary.pdf",
    "demo-client/aektanagar/uav/point-cloud-summary.pdf", "application/pdf",
    "50,183,644 points at 181.7 per m2, ground and unclassified returns, LAS 1.2. Read from the file header. The cloud itself needs a point cloud viewer, which is not built yet.", 1],
